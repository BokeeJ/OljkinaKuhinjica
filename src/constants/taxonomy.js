...
export const SECTIONS_BY_CATEGORY = {
  ...
  const PRETTY_LABELS_ENTRIES = [
    ...
    // ✅ NOVE SEKCIJE
    ["Topli i hladni napici", "Topli i hladni napici"],
    ["Salate", "Salate"],
    ["Hlebovi i pogače", "Hlebovi i pogače"],
  ...
  export const normalizeSectionFE = (s = "") => {
    ...
    // ✅ Topli i hladni napici
    if (["napici", "napitci", "topli i hladni napici", "topli hladni napici"].includes(k)) {
      return "Topli i hladni napici";
    }
  
    // ✅ Hlebovi i pogače
    if (["hlebovi i pogace", "hlebovi pogace", "hlebovi-pogace"].includes(k)) {
      return "Hlebovi i pogače";
    }
  
    // ✅ Salate
    if (["salata", "salate"].includes(k)) {
      return "Salate";
    }
